...
\begin{wrapfigure}{r}{0.37\textheight}
\centering
...
\caption{Microphone Signal (idle state) from a Finger Board, measured at the Arduino input pin}
\label{fig:sig_1}
\end{figure}
...
\caption{Microphone Signal from a Finger Board with PWM Frequency = 30Hz, measured at the Arduino input pin}
\label{fig:sig_2}
\end{figure}
