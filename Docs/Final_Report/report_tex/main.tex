...
\caption{Function Diagram of Audio Transfer between storage buffers for each connected Board and the audio device, Prototype 0.2.01}
\label{fig:juceflow}
\end{figure}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Testing} \label{Evaluation}
...
///// sampled signal of idle state and ring tap, take from queueInput
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Evaluation} \label{Progress Evaluation}
...
\begin{wraptable}{r}{0.3\textheight}
\begin{center}
\begin{tabular}{| l r r}
