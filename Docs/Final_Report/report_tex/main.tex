...
\caption{Microphone Signal (idle state), measured at the Arduino input pin}
\label{fig:sig_1}
\end{figure}
...
\caption{Microphone Signal with PWM Frequency = 30Hz, measured at the Arduino input pin}
\label{fig:sig_2}
\end{figure}
...
!! MISSING IMAGE !!
%\includegraphics[width=0.6\textheight, height=0.45\textheight]{Images/sig_2_tap.eps}
\caption{Microphone Signal with PWM Frequency = 30Hz, received by the Interface program}
\label{fig:sig_samp}
\end{figure}
