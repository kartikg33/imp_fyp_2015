...
The aim of this project was to design a musical instrument and implement a part of it as a demonstrable proof-of-concept. I developed a Prototype which allowed a user to wear three microphones on their fingers and control the functionality of each individually through a software Interface. This implementation allowed me to prove that my idea for a wearable musical instrument that was flexible in its use and easy and intuitive to program by any type of user, which is quite a significant step. 
